...
import me.adibfarrasy.ktor.demo.generated.information_schema.tables.records.InnodbCmpRecord
...
open class InnodbCmp(
    ...
    path: ForeignKey<out Record, InnodbCmpRecord>?,
    ...
    private constructor(alias: Name, aliased: Table<InnodbCmpRecord>?): this(alias, null, null, aliased, null)
    private constructor(alias: Name, aliased: Table<InnodbCmpRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, aliased, parameters)
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, InnodbCmpRecord>): this(Internal.createPathAlias(child, key), child, key, INNODB_CMP, null)
